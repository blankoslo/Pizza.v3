    ...
    return (
        <div className="root">
            <div className="text-container">
                <div className="main-text">The sexiest bot for socialising teams on slack through Pizza..</div>
            ...
            <div className="firstpage-img">
                <Image priority src={Hello} height={435} width={566} alt="bot saying hello" />
            </div>
        </div>
    )
}
